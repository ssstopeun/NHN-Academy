...
public class ViewResolver {
    ...
    public  String getPath(String viewName){
        ...
        return viewName.startsWith("/")?prefix+viewName.substring(1)+postfix:prefix+viewName+postfix;
    }
    ...
    public String getLayOut(String viewName){
        ...
        */
        ...
        String[] viewNameElements = viewName.split("/");
        for(String viewNameElement :viewNameElements){
            if(viewNameElement.equals("admin")){
